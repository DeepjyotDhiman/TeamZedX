    ...
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col fixed h-full shadow-sm">
        <div className="p-6 border-b border-slate-100">
          ...
          <p className="text-[10px] text-rose-400 font-bold mt-2 uppercase italic">Admin Portal</p>
        </div>
      ...
      <main className="flex-1 ml-64">
        <header className="bg-white border-b border-slate-200 px-8 py-4 flex justify-between items-center sticky top-0 z-10">
          <h2 className="text-xl font-bold italic text-slate-700 capitalize underline decoration-slate-100">{activeTab}</h2>
